...
if __name__ == '__main__':
    ...
    original_train_data_file = prj_path + '/data\\wine_menus\\train.json'
    questions_path = prj_path + '/data\\wine_menus\\question_list.json'
    output_file = prj_path + '/data\\wine_menus\\train.json'
